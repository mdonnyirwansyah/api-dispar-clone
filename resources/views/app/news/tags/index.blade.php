...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item">News Tags</div>
    </div>
  </div>
  <div class="section-body">
    <h2 class="section-title">List of News Tags</h2>
    <p class="section-lead">This page is for managing news tags.</p>
    <div class="card">
      <div class="card-body">
        <div class="col-12">
          <div class="section-header-button mb-3">
            <button class="btn btn-primary" onClick="createRecord()">Add New</button>
            <button class="btn btn-danger" id="btn-delete-checkbox" data-route="{{ route('news.tags.destroy.checked') }}" style="display: none"></button>
          </div>
          <hr>

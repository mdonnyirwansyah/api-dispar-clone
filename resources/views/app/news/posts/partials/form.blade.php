...
<div class="form-group row mb-4">
  ...
  <div class="col-sm-12 col-md-7">
      <textarea class="form-control form-control-sm" name="content" id="content"> @isset($newsPost) {{ $newsPost->content }} @endisset</textarea>
...
<div class="form-group row mb-4">
  ...
  <div class="col-sm-12 col-md-7">
      <textarea class="form-control form-control-sm" name="content_en" id="content_en"> @isset($newsPost) {{ $newsPost->content_en }} @endisset</textarea>
...
<div class="form-group row mb-4">
  ...
  <div class="col-sm-12 col-md-7">
    ...
    <footer class="blockquote-footer">The thumbnail must be a file of type: <cite title="Source Title">jpg, jpeg, png, webp. And max 2048 kb.</cite></footer>
